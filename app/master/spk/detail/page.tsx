  ...
  return (
    <main className="spk-detail-page">
      <section className="spk-detail-content">
        ...
        <section className="spk-detail-info-panel"><div className="spk-detail-section-title">Informasi SPK</div><div className="spk-detail-info-grid"><Info label="Tanggal SPK" value={spk.tgl_spk} /><Info label="Jenis Bobot" value={spk.jenis_bobot} /><Info label="Kantor/Pelaksana" value={office?.nama_kantor_pelaksana ?? spk.id_kantor} /><Info label="Mandor" value={mandor?.nama_mandor ?? spk.id_mandor} /><Info label="Update Terakhir" value={decision?.tanggal_update_terakhir ?? latestPeriod?.date ?? 'Belum ada'} /><Info label="Hari Sejak Update" value={decision?.tanggal_update_terakhir ? `${decision.hari_sejak_update} hari` : 'Belum ada'} /><Info label="Status SPK" value={spk.status_spk} /><Info label="Target Selesai" value={spk.tgl_target_selesai} /></div></section>
