        ...
        <section className="kavio-panel kvio-create-panel">
          <div className="kavio-panel-head">
            <div>
              ...
              <div className="kavio-panel-note">SPK dibuat sebagai DRAFT dan baru menjadi aktif setelah konfigurasi bobot valid.</div>
            </div>
          ...
          <form action={createSpk} className="kavio-form kvio-spk-form">
            ...
            <div className="kavio-form-note"><strong>ATURAN:</strong> Sales tidak wajib. SPK baru hanya untuk kavling AVAILABLE atau BOOKING. Saat aktif, kavling menjadi BUILDING. Mandor harus berasal dari kantor yang dipilih dan tipe rumah SPK mengikuti kavling.</div>
